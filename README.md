...
Current Packet A/B operations include device material generation, public prekey
bundle export, and first-message `encryptEnvelope`. Message decryption remains a
later packet.
